...
├── src/
│   ├── rebar3_lfe.app.src
│   ├── r3lfe.erl                    % Plugin entry point
│   ├── r3lfe_compiler_mod.erl       % rebar_compiler behavior
│   ├── r3lfe_config.erl             % Configuration management
│   └── r3lfe_paths.erl              % Path management
├── test/
│   ├── r3lfe_config_SUITE.erl
│   ├── r3lfe_paths_SUITE.erl
...
**File: `src/r3lfe_compiler_mod.erl`**
...
**File: `test/r3lfe_config_SUITE.erl`**
...
get_lfe_opts_merged(_Config) ->
    ...
    Opts = r3lfe_config:get_lfe_opts(AppInfo1),
...
**File: `test/r3lfe_paths_SUITE.erl`**
...
# Run specific suite
rebar3 ct --suite=test/r3lfe_config_SUITE
