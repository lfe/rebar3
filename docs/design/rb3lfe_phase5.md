...
**File: `src/rb3lfe_prv_compile.erl`**
...
**File: `src/rb3lfe_prv_clean.erl`**

```erlang
-module(rb3lfe_prv_clean).
-behaviour(provider).
...
**File: `src/rb3lfe_prv_repl.erl`**

```erlang
-module(rb3lfe_prv_repl).
-behaviour(provider).
...
**File: `src/rb3lfe_prv_ltest.erl`**

```erlang
-module(rb3lfe_prv_ltest).
-behaviour(provider).
...
**File: `src/rb3lfe_prv_release.erl`**
...
**File: `src/rb3lfe_prv_versions.erl`**

```erlang
-module(rb3lfe_prv_versions).
-behaviour(provider).
