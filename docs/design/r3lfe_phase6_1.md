...
init_per_suite(Config) ->
    ...
    application:ensure_all_started(r3lfe),
    Config.
...
**File: `test/r3lfe_prv_run_SUITE.erl`**
...
run_with_arguments(Config) ->
    ...
    %% Run provider
    Result = r3lfe_prv_run:do(State2),
...
**File: `test/r3lfe_prv_escriptize_SUITE.erl`**
...
run_escript_executes(Config) ->
    ...
    State = create_state(TestDir),
    {ok, State1} = r3lfe_prv_compile:do(State),
    {ok, State2} = r3lfe_prv_escriptize:do(State1),
...
rebar3 ct --suite=test/r3lfe_prv_run_SUITE
rebar3 ct --suite=test/r3lfe_prv_escriptize_SUITE
