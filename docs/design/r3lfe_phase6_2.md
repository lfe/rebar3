...
**File: `src/r3lfe_prv_release.erl` (UPDATE)**
...
**File: `test/r3lfe_prv_run_release_SUITE.erl`**
...
build_and_run_release(Config) ->
    ...
    Result = r3lfe_prv_release:do(State1),
...
release_start_stop(Config) ->
    ...
    State = create_state(TestDir),
    {ok, State1} = r3lfe_prv_compile:do(State),
    {ok, State2} = r3lfe_prv_release:do(State1),
    ...
    _Result = r3lfe_prv_run_release:do(State3),
...
rebar3 ct --suite=test/r3lfe_prv_run_release_SUITE
