...
This document provides a comprehensive reference for rebar3 modules commonly used by plugin developers. Do note, however -- it is a _partial_ reference. Not all modules are represented here.
